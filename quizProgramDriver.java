...
public class quizProgramDriver extends Application {
   ...
   public void makeQuiz_OnClick() {
      ...
      btnContinueQuiz.setOnAction(e -> {
         ...
         } else if (SnumPass.getValue()>(SnumOfQ.getValue() / SnumTeams.getValue())) {
            checkName.setLayoutY(290);
            checkName.setLayoutX(25);
            checkName.setText("The pass mark is too high!");
         } else {
   ...
   public void Teamdisplay_Click(int index) {
      ...
      //Text error = new Text("");
     // error.setLayoutY(240);
      //error.setLayoutX(5);
      
      
      startQuiz.setOnAction(e -> {
         //if(!member1a.getText().equals("") && !member1b.getText().equals("")&& !member1c.getText().equals("")&& !member2a.getText().equals("")&& !member2b.getText().equals("")&& !member2c.getText().equals("")&& !member3a.getText().equals("")&& !member3b.getText().equals("")&& !member3c.getText().equals("")){
        ...
        //}
        //else{
         //error.setText("The teams name must be put before start the quiz!");
     //}
      });
